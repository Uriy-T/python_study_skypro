...
sdb_valid_data: list[dict[str, Any]] = [
    {
        "data_for_sort": [
            {
                "id": 41428829,
...
sdb_valid_data_partial: list[dict[str, Any]] = [
    {
        "data_for_sort": [
            {
                "id": 41428829,
...
sdb_invalid_data: list[dict[str, Any]] = [
    {
        "data_for_sort": [],
        "sort_order": True,
    ...
    },
    {
        ...
        "sort_order": True,
        "system_answer": "data_for_sort должен быть list." "Получен тип: dict",
    ...
    },
    {
        ...
        "sort_order": True,
        "system_answer": "data_for_sort должен быть list." "Получен тип: set",
        "exception_type": TypeError,
    },
    {
        "data_for_sort": [
