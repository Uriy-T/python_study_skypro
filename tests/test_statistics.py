...
@pytest.mark.parametrize(param_packer(statistics_test_valid_data),
...
def test_count_by_descr_positive(
    ...
    found_transactions = transactions_by_categories(transaction_data,
                                                    count_categories)
    assert found_transactions == expected_result


@pytest.mark.parametrize(param_packer(statistics_test_invalid_data),
...
def test_count_by_descr_negative(
    ...
    with pytest.raises(exception_type) as exc_info:
        transactions_by_categories(transaction_data,
                        count_categories)
