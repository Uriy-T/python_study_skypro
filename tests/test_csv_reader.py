...
from data_for_test.table_data_readers.csv_reader_test_data import (
    get_info_invalid_data,
    get_info_path_invalid_data,
    get_info_valid_data,
)
from src.table_data_readers import csv_reader
...
def test_get_transaction_csv_positive(
    file_for_read: str, expected_data: list[dict[str, Any]]
) -> None:
    data_from_file = csv_reader(file_for_read)
...
def test_get_transaction_csv_negative(
...
def test_get_transaction_csv_path_negative(
